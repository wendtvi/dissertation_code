...
#Dist conhecida
plot(((q_00-mean(q_00))/sd(q_00)-(q_01-mean(q_01))/sd(q_01))-((q_10-mean(q_10))/sd(q_10)-(q_11-mean(q_11))/sd(q_11)),type = 'l',ylim = c(-2,2),ylab="Diferença entre quantis",x=t)
lines(((q_00-mean(q_00))/sd(q_00)-(q_01-mean(q_01))/sd(q_01))-((q_10-mean(q_10))/sd(q_10)-(q_11-mean(q_11))/sd(q_11))+
              1.96*rep(sd(((q_00-mean(q_00))/sd(q_00)-(q_01-mean(q_01))/sd(q_01))-((q_10-mean(q_10))/sd(q_10)-(q_11-mean(q_11))/sd(q_11))),length(t)),col="red")
lines(((q_00-mean(q_00))/sd(q_00)-(q_01-mean(q_01))/sd(q_01))-((q_10-mean(q_10))/sd(q_10)-(q_11-mean(q_11))/sd(q_11))-
        1.96*rep(sd(((q_00-mean(q_00))/sd(q_00)-(q_01-mean(q_01))/sd(q_01))-((q_10-mean(q_10))/sd(q_10)-(q_11-mean(q_11))/sd(q_11))),length(t)),col="red")

mean(abs(((q_00-mean(q_00))/sd(q_00)-(q_01-mean(q_01))/sd(q_01))-((q_10-mean(q_10))/sd(q_10)-(q_11-mean(q_11))/sd(q_11))))
...
e_cdf10 =  plnorm(y_10,meanlog = mean(log(y_10)),sdlog = sd(log(y_10)))
e_cdf11 =  plnorm(y_10,meanlog = mean(log(y_11_t)),sdlog = sd(log(y_11_t)))
plot(abs((e_cdf00-mean(e_cdf00))/sd(e_cdf00)-(e_cdf01-mean(e_cdf01))/sd(e_cdf01)-((e_cdf10-mean(e_cdf10))/sd(e_cdf10)-(e_cdf11-mean(e_cdf11))/sd(e_cdf11))),type = 'l',ylim = c(-2,2))
mean(abs((e_cdf00-mean(e_cdf00))/sd(e_cdf00)-(e_cdf01-mean(e_cdf01))/sd(e_cdf01)-((e_cdf10-mean(e_cdf10))/sd(e_cdf10)-(e_cdf11-mean(e_cdf11))/sd(e_cdf11))))
...
diff_quantiles0=vector()
diff_quantiles1=vector()
prob=seq(0,1,0.01)
c=0
for(p in prob){
  c=c+1
...
mean(abs(diff_quantiles0-diff_quantiles1))
